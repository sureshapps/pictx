	...
	return (
		<html lang="en">
			...
			>
				...
				<p className="lg:flex flex-row justify-between text-center text-xs dark:text-gray-400 text-gray-600 select-none">
				...
				<main className="grow flex flex-col lg:flex-row gap-6 py-4 lg:py-10">
					...
					<p>
						Built with ♡ by<A href="https://suresh.app">Suresh Kaleyannan
